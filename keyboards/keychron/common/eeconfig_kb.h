...
#    include "eeconfig_spam_macro.h"
#    define __EECONFIG_SIZE_SPAM_MACRO EECONFIG_SIZE_SPAM_MACRO
#else
#    define __EECONFIG_SIZE_SPAM_MACRO 0
#endif
#define EECONFIG_BASE_SPAM_MACRO EECONFIG_END_WIRELESS_CONFIG
#define EECONFIG_END_SPAM_MACRO (EECONFIG_BASE_SPAM_MACRO + __EECONFIG_SIZE_SPAM_MACRO)

#undef EECONFIG_KB_DATA_SIZE
#define EECONFIG_KB_DATA_SIZE (EECONFIG_END_SPAM_MACRO - EECONFIG_BASE_LANGUAGE)
